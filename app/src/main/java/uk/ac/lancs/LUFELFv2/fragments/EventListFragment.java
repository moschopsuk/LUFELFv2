...
public class EventListFragment extends ListFragment {
    ...
    public void onListItemClick(ListView listView, View view, int position, long id) {
        ...
        mCallbacks.onItemSelected(eventID);
    }
    ...
    public class FetchEventsTaskAsync extends AsyncTask<String, Void, ArrayList<EventItem>> {
        ...
        @Override
        protected void onPostExecute(ArrayList<EventItem> e) {
            EventsListAdapter listAdapter = new EventsListAdapter(getActivity(), events);
